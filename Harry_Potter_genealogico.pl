...
%---- ESTA SERÍA LA REGLA RECURSIVA -----
%El caso base es si ya es un hecho qu A es de sangre pura.
%y se usa el ! para que prolog no explore más opciones
es_sangre_pura(A) :- 
    sangre_pura(A), 
    !. 
...
%--- ESTAS SERÍAN LAS REGLAS PARA CONSUKTAR EN LAS QUERIES
% Caso es puro:
